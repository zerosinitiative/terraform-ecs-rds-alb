...
variable "allocated_storage" {
  description = "The storage space allocated to the database"
  type        = number
  default     = 20
}

variable "storage_type" {
  description = "The storage type allocated to the database"
  type        = string
  default     = "gp2"
}
...
variable "instance_class" {
  description = "The instance_class for the database"
  type        = string
  default     = "db.t2.micro"
}

...
resource "aws_launch_configuration" "cluster" {
  name_prefix   = "cluster-${var.deployment_identifier}-${var.cluster_name}-"
...
resource "aws_autoscaling_group" "cluster" {
  name_prefix = "asg-${var.deployment_identifier}-${var.cluster_name}-"
  ...
  tag {
    key                 = "Name"
    value               = "cluster-worker-${var.deployment_identifier}-${var.cluster_name}"
